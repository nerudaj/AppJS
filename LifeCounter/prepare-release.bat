...
cd app
cd src
jsbloat app.js helper.js lang.js wave.js time_control.js main.js score.js chance.js timer.js timer_settings.js settings.js advanced_settings.js -H hints.txt
